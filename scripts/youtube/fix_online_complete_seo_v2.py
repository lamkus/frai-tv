#!/usr/bin/env python3
"""
🚀 FIX ONLINE WOCHENSCHAU VIDEOS - COMPLETE SEO UPDATE v2
=========================================================
Mit bereinigten Tags (YouTube-kompatibel)
"""
...
def sanitize_tags(tags):
    """
    Bereinige Tags für YouTube API
    - Max 30 Tags
    - Keine Sonderzeichen außer alphanumerisch und Leerzeichen
    - Max 100 chars pro Tag
    - Keine doppelten
    """
    clean_tags = []
    seen = set()
    ...
    for tag in tags:
        # Bereinigen: Nur alphanumerisch, Leerzeichen, und einige Sonderzeichen
        # YouTube erlaubt: letters, numbers, spaces
        clean = tag.strip()
...
def update_video_complete(youtube, video_id, seo_data):
    ...
    try:
        ...
        # Tags bereinigen
        clean_tags = sanitize_tags(seo_data['tags'])
        ...
        return {
            ...
            "changes": {
                ...
                "tags": {"old_count": len(old_tags), "new_count": len(clean_tags)},
            }
        }
...
def main():
    print("=" * 70)
    print("🚀 FIXING ONLINE WOCHENSCHAU VIDEOS - COMPLETE SEO v2")
    print("=" * 70)
    ...
    for nr, video_id in ONLINE_VIDEOS.items():
        ...
        print(f"      Tags: {len(clean_tags)} tags (cleaned from {seo_data['tags_count']})")
